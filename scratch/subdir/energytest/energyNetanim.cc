...
main(int argc, char* argv[])
{
    ...
    energyDevices.Add(apDevices.Get(0));
    energyDevices.Add(staDevices.Get(0));
    ...
    energySource1->SetInitialEnergy(2000);
    energySource1->SetNode(wifiApNode.Get(0));
    energySource2->SetInitialEnergy(2000);
    energySource2->SetNode(wifiStaNodes.Get(0));

    DeviceEnergyModelContainer deviceModel1 = energyHelper.Install(energyDevices.Get(0), energySource1);
    DeviceEnergyModelContainer deviceModel2 = energyHelper.Install(energyDevices.Get(1), energySource2);



    wifiApNode.Get(0)->AggregateObject(energySource1);
    wifiStaNodes.Get(0)->AggregateObject(energySource2);
    ...
    clientApps.Stop(Seconds(1500.0));
