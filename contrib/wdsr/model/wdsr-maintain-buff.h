...
#ifndef WDSR_MAINTAIN_BUFF_H
#define WDSR_MAINTAIN_BUFF_H
...
/**
 * \ingroup wdsr
 * \brief WDSR Maintain Buffer Entry
 */
class WDsrMaintainBuffEntry
{
  public:
    /**
     * Construct a WDsrMaintainBuffEntry with the given parameters
     *
     * \param packet packet
     ...
     */
    WDsrMaintainBuffEntry(Ptr<const Packet> packet = nullptr,
...
/**
 * \ingroup wdsr
 * \brief WDSR maintain buffer
 */
/************************************************************************************************************************/
class WDsrMaintainBuffer
{
  public:
    /**
     * Default constructor
    ...
    bool Enqueue(WDsrMaintainBuffEntry& entry);
    /// Return first found (the earliest) entry for given destination
    /// \param [in] dst Entry destination
    /// \param [out] entry The Entry found (if any).
    /// \return true on success
    bool Dequeue(Ipv4Address dst, WDsrMaintainBuffEntry& entry);
    ...
    bool AllEqual(WDsrMaintainBuffEntry& entry);
    /// Verify if the maintain buffer entry is the same in every field for link ack
    /// \param entry The Entry to check
    /// \return true if an Entry was found and removed.
    bool LinkEqual(WDsrMaintainBuffEntry& entry);
    /// Verify if the maintain buffer entry is the same in every field for network ack
    /// \param entry The Entry to check
    /// \return true if an Entry was found and removed.
    bool NetworkEqual(WDsrMaintainBuffEntry& entry);
    /// Verify if the maintain buffer entry is the same in every field for promiscuous ack
    /// \param entry The Entry to check
    /// \return true if an Entry was found and removed.
    bool PromiscEqual(WDsrMaintainBuffEntry& entry);

  private:
    /// The vector of maintain buffer entries
    std::vector<WDsrMaintainBuffEntry> m_maintainBuffer;
