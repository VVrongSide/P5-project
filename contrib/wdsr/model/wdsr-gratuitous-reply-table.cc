...
NS_LOG_COMPONENT_DEFINE("WDsrGraReplyTable");

namespace wdsr
{

NS_OBJECT_ENSURE_REGISTERED(WDsrGraReply);

TypeId
WDsrGraReply::GetTypeId()
{
    static TypeId tid = TypeId("ns3::wdsr::WDsrGraReply")
                            .SetParent<Object>()
                            .SetGroupName("WDsr")
                            .AddConstructor<WDsrGraReply>();
    return tid;
}

WDsrGraReply::WDsrGraReply()
{
}
...
bool
WDsrGraReply::FindAndUpdate(Ipv4Address replyTo, Ipv4Address replyFrom, Time gratReplyHoldoff)
{
...
bool
WDsrGraReply::AddEntry(GraReplyEntry& graTableEntry)
{
