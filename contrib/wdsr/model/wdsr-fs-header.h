...
#ifndef WDSR_FS_HEADER_H
#define WDSR_FS_HEADER_H
...
/**
 * \class WDsrHeader
 * \brief Header for WDsr Routing.
 */

/**
* \ingroup wdsr
* \brief WDsr fixed size header Format
  \verbatim
   |      0        |      1        |      2        |      3        |
...
/**
* \ingroup wdsr
* \brief The modified version of WDsr fixed size header Format
  \verbatim
   |      0        |      1        |      2        |      3        |
   0 1 2 3 4 5 6 7 0 1 2 3 4 5 6 7 0 1 2 3 4 5 6 7 0 1 2 3 4 5 6 7
   +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
  ...
  \endverbatim
*/
class WDsrFsHeader : public Header
{
  public:
    /**
...
/**
 * \class WDsrOptionField
 * \brief Option field for an WDsrFsHeader
 * Enables adding options to an WDsrFsHeader
 *
 * Implementor's note: Make sure to add the result of
 * OptionField::GetSerializedSize () to your WDsrFsHeader::GetSerializedSize ()
 * return value. Call OptionField::Serialize and OptionField::Deserialize at the
 * end of your corresponding WDsrFsHeader methods.
 */
class WDsrOptionField
{
  public:
     ...
     */
    WDsrOptionField(uint32_t optionsOffset);
    /**
     * \brief Destructor.
     */
    ~WDsrOptionField();
     ...
     */
    void AddWDsrOption(const WDsrOptionHeader& option);
    /**
     ...
     */
    uint32_t GetWDsrOptionsOffset();
    /**
     * \brief Get the buffer.
     * \return buffer
     */
    Buffer GetWDsrOptionBuffer();
  ...
  private:
     ...
     */
    uint32_t CalculatePad(WDsrOptionHeader::Alignment alignment) const;
    /**
     * \brief Data payload.
     */
    Buffer m_optionData;
...
/**
 * \class WDsrRoutingHeader
 * \brief Header of WDsr Routing
 */
class WDsrRoutingHeader : public WDsrFsHeader, public WDsrOptionField
{
  public:
    /**
     * \brief Get the type identificator.
...
operator<<(std::ostream& os, const WDsrRoutingHeader& wdsr)
{
    wdsr.Print(os);
    return os;
}
