...
#ifndef WDSR_ERRORBUFF_H
#define WDSR_ERRORBUFF_H
...
/**
 * \ingroup wdsr
 * \brief WDSR Error Buffer Entry
 */
class WDsrErrorBuffEntry
{
  public:
    /**
     * Create an WDsrErrorBuffEntry with the given parameters.
     *
     * \param pa packet
     ...
     */
    WDsrErrorBuffEntry(Ptr<const Packet> pa = nullptr,
     ...
     * \param o another WDsrErrorBuffEntry
     * \return true if equal
     */
    bool operator==(const WDsrErrorBuffEntry& o) const
    {
...
/**
 * \ingroup wdsr
 * \brief WDSR error buffer
 */
/************************************************************************************************************************/
class WDsrErrorBuffer
{
  public:
    /**
     * Default constructor
     ...
     */
    bool Enqueue(WDsrErrorBuffEntry& entry);
    /**
     ...
     */
    bool Dequeue(Ipv4Address dst, WDsrErrorBuffEntry& entry);
    /**
     ...
     * \returns the WDSR error buffer
     */
    std::vector<WDsrErrorBuffEntry>& GetBuffer()
    {
  ...
  private:
    ...
    std::vector<WDsrErrorBuffEntry> m_errorBuffer;
     ...
     */
    ///
    void Drop(WDsrErrorBuffEntry en, std::string reason);
    /**
     * Notify that packet is dropped from queue by link error
     * \param en Error Buffer Entry
     * \param reason Drop reason.
     */
    void DropLink(WDsrErrorBuffEntry en, std::string reason);
