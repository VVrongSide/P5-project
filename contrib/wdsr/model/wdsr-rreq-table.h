...
#ifndef WDSR_RREQ_TABLE_H
#define WDSR_RREQ_TABLE_H
 ...
 */
class WDsrReceivedRreqEntry
{
  public:
    /**
     * Construct a WDsrReceivedRreqEntry with the given parameters
     *
     * \param d IPv4 address of the destination
     * \param i identification
     */
    WDsrReceivedRreqEntry(Ipv4Address d = Ipv4Address(), uint16_t i = 0)
        : m_destination(d),
          m_identification(i)
    {
    }
     ...
     * \param o another WDsrReceivedRreqEntry
     * \return true if equal
     */
    bool operator==(const WDsrReceivedRreqEntry& o) const
    {
...
/**
 * \ingroup wdsr
 * \brief maintain list of WDsrRreqTable entry
 */
class WDsrRreqTable : public Object
{
  public:
    /**
  ...
  private:
    ...
    /// Map of entries
    std::list<WDsrReceivedRreqEntry> m_sourceRequests;
    ...
    std::map<Ipv4Address, std::list<WDsrReceivedRreqEntry>> m_sourceRreqMap;
